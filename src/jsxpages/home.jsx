...
const Homepage = () => {
    ...
    const openApplePay = () => setShowApplePay(true);
    const closeApplePay = () => setShowApplePay(false);
    ...
    return (
        <>
            ...
            <div className='flex bg-black mx-8 py-2 px-4 rounded-xl' onClick={openApplePay}>
